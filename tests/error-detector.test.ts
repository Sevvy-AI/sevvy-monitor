...
import { detectErrorsInLogs, groupErrorsByPattern, getErrorSummary } from '../src/integrations/cloudwatch/error-detector.js';
...
describe('Error Detector', () => {
  ...
  describe('detectErrorsInLogs', () => {
    ...
    it('should detect errors with custom patterns', () => {
      ...
      const customErrors = errors.filter(error => error.pattern === 'Custom Warning');
